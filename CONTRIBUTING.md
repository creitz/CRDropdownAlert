...
All code contributions should match our coding conventions [Swift](https://github.com/github/swift-style-guide)). If your particular case is not described in the coding convention, check the CRDropdownAlert codebase.
